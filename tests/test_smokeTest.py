...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.set_window_size(1149, 1012)
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("TestWrong")
    self.driver.find_element(By.ID, "password").send_keys("testwrong")
  ...
  def test_homePage(self):
    ...
    self.driver.set_window_size(1266, 1032)
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Aviles")
    self.driver.find_element(By.NAME, "bizname").send_keys("Big Potato")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Big Shot")
